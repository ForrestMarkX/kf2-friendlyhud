...
simulated event PostBeginPlay()
{
    ...
    if (Role == ROLE_Authority)
    {
        ...
        RepInfo = Spawn(class'FriendlyHUDExt.FriendlyHUDReplicationInfo', Self);
        RepInfo.FHUDMutator = Self;
        RepInfo.HUDConfig = HUDConfig;

        CDCompat = Spawn(class'FriendlyHUDExt.FriendlyHUDCDCompatController', Self);
...
simulated function InitializeHUD()
{
    ...
    HUDConfig = new (KFPC) class'FriendlyHUDExt.FriendlyHUDConfig';
...
simulated function InitializeDeferred()
{
    ...
    FHUDInteraction = new (KFPC) class'FriendlyHUDExt.FriendlyHUDInteraction';
...
simulated function InitializeCompat()
{
    ...
    UMInteraction = new (KFPC) class'FriendlyHUDExt.UMCompatInteraction';
...
function bool CheckReplacement(Actor Other) 
{
    ...
    if( Turret != None )
	{
        Turret.PlayerReplicationInfo = Spawn(class'FriendlyHudExt.SentinelReplicationInfo', Turret,, vect(0,0,0), rot(0,0,0));
